...
# os.chdir(r"E:\工作\2020-10-09-5 01_肠道菌-疾病 预测\2021-12-13-特征基于点二列相关\分类model\step1-特征提取\微生物特征提取")
...
# all_species = sorted(set(s_m["species"]))
...
print()
with open("species_feature_5.csv", "w") as fw1:
    species_num = len(species)
    for spe in species[46:56]:
